...
function maxUint120() returns uint128 {
...
rule previewDepositHasNOTrashold(env e1, env e2) {
    require getLastUpdated() < e1.block.timestamp;
    require e1.block.timestamp < e2.block.timestamp;
    require e2.block.timestamp < 0xffffff;
...
rule previewWithdrawAmountCheck(env e1, env e2) {
    require getLastUpdated() < e1.block.timestamp;
    require e1.block.timestamp < e2.block.timestamp;
    require e2.block.timestamp < 0xffffff;
